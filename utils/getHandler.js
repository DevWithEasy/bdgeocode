...
export async function getDistricts(id,setDistricts,setUpazillas,setUnions) {
    const res = await axios.get(`https://bdgeocode.vercel.app/api/v.1/district/${id}`)
...
export async function getUpazillas(id,setUpazillas,setUnions) {
    const res = await axios.get(`https://bdgeocode.vercel.app/api/v.1/upazilla/${id}`)
    setUpazillas(res.data.data);
    setUnions([])
}

export async function getUnions(id,setUnions) {
    const res = await axios.get(`https://bdgeocode.vercel.app/api/v.1/union/${id}`)
